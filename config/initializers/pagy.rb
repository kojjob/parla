...
# Pagy::Calendar::DEFAULT[:year][:order]   = :asc        # Time direction
# Pagy::Calendar::DEFAULT[:year][:format]  = '%Y'        # strftime format
# Pagy::Calendar::DEFAULT[:month][:order]  = :asc        # Time direction
# Pagy::Calendar::DEFAULT[:month][:format] = '%Y-%m'     # strftime format
# Pagy::Calendar::DEFAULT[:week][:order]   = :asc        # Time direction
# Pagy::Calendar::DEFAULT[:week][:format]  = '%Y-%W'     # strftime format
# Pagy::Calendar::DEFAULT[:day][:order]    = :asc        # Time direction
# Pagy::Calendar::DEFAULT[:day][:format]   = '%Y-%m-%d'  # strftime format
# Pagy::Calendar::DEFAULT[:hour][:order]   = :asc        # Time direction
# Pagy::Calendar::DEFAULT[:hour][:format]  = '%Y-%m-%d %H'      # strftime format
# Pagy::Calendar::DEFAULT[:minute][:order] = :asc        # Time direction
# Pagy::Calendar::DEFAULT[:minute][:format]= '%Y-%m-%d %H:%M'   # strftime format
# Pagy::Calendar::DEFAULT[:second][:order] = :asc        # Time direction
# Pagy::Calendar::DEFAULT[:second][:format]= '%Y-%m-%d %H:%M:%S'# strftime format
...
# Standalone extra: Use pagy in non Rack environment/application
